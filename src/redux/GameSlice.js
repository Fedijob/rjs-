  ...
  games: [
    {
      ...
      description:
        "League of Legends is a team-based game with over 140 champions to make epic plays with  Terrorists and Counter-Terrorists, against each other in different objective -based game modes.",
    },
    {
      id: Math.random(),
      ...
      description:
        "The game pits two teams, Terrorists and Counter-Terrorists, against each other in different objective-based game modes. The most common game modes involve the Terrorists planting a bomb while Counter-Terrorists attempt to stop them.",
    },
    {
      id: Math.random(),
      name: "Apex Legends",
      ...
      description:
        "Apex Legends is an online multiplayer battle royale game featuring squads of three players using pre-made characters with distinctive abilities, called 'Legends', similar to those of hero shooters.",
    },
    {
      id: Math.random(),
      name: "Valorant",
    ...
    },
    {
      ...
      description:
        "Star Wars Jedi: Fallen Order is an action-adventure game set after the events of Star Wars: Revenge of the Sith. Develop your Force abilities, hone your lightsaber techniques, and explore the ancient mysteries of a long-lost civilization.",
    },
  ],
};
...
export const GameSlice = createSlice({
  ...
  reducers: {
    ...
    removegame: (state, action) => {
      state.games = state.games.filter((el) => el.name !== action.payload.name);
    },
    editgame: (state, action) => {
      let i = state.games.findIndex((el) => el.name === action.payload.name);
      state.games[i] = {
        ...state.games[i],
